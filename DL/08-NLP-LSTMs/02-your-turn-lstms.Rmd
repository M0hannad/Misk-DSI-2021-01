...
* [Intro to word embeddings](https://misk-data-science.github.io/misk-dl/notebooks/08-word-embeddings.nb.html)
* [Intro to LSTMs](https://misk-data-science.github.io/misk-dl/notebooks/12-intro-to-lstms.nb.html)
...
workshop, you can find the download instructions [here](https://github.com/misk-data-science/misk-dl/blob/master/materials/01-intro/01-requirements.md).
...
to [Intro to word embeddings](https://misk-data-science.github.io/misk-dl/notebooks/08-word-embeddings.nb.html), let's go ahead
...
```{r}
# reference https://misk-data-science.github.io/misk-dl/notebooks/08-word-embeddings.nb.html 
# for code options
```
...
layer you __do not__ need to flatten the layer. Reference the [Intro to LSTMs notebook](https://misk-data-science.github.io/misk-dl/notebooks/12-intro-to-lstms.nb.html). For this first LSTM model
use `units = 32`.
...
* LSTM layer
   ...
   - add dropout (ref [LSTM section](https://misk-data-science.github.io/misk-dl/notebooks/12-intro-to-lstms.nb.html#your_turn_(5min)8))
