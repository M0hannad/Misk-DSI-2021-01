...
You can find the download instructions [here](https://github.com/misk-data-science/misk-dl/blob/master/materials/01-intro/01-requirements.md). For those
...
and word relationships. [ℹ️](https://misk-data-science.github.io/misk-dl/03-word-embeddings.html)
...
code behind these helper functions [here](https://github.com/misk-data-science/misk-dl/blob/master/materials/06-word-embeddings/helper_functions.R).
...
weights that optimize the classification loss function. [ℹ️](https://misk-data-science.github.io/misk-dl/03-word-embeddings.html#13)
...
[helper_functions.R](https://github.com/misk-data-science/misk-dl/blob/master/materials/06-word-embeddings/helper_functions.R) file. You can see the word 
...
* Word embeddings
   ...
   - We can measure similarity with cosine similarity (other distance functions
      are also used).
   - See https://misk-data-science.github.io/misk-dl/03-word-embeddings.html#12 for list of resources to go deeping into word
     embeddings.
