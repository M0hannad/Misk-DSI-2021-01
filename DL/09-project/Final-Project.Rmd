...
collaborative filtering notebook [ℹ️](https://misk-data-science.github.io/misk-dl/notebooks/11-collaborative-filtering.nb.html) with a
...
1. Save your final preprocessing tokenizer to the `misk-dl/materials/09-project`
directory.
```{r}
save_text_tokenizer(tokenizer, "tokenizer-question-pairs")
```

2. Save your final model to the `misk-dl/materials/09-project` directory.
```{r}
...
`misk-dl/materials/09-project` directory.
